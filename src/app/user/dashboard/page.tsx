    ...
    <main className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 bg-white shadow rounded">
          ...
          {loading ? (
            <div className="animate-pulse text-3xl font-bold mt-2 bg-gray-200 h-8 w-20 rounded"></div>
          ) : (
        ...
        <div className="p-6 bg-white shadow rounded">
          ...
          {loading ? (
            <div className="animate-pulse text-3xl font-bold mt-2 bg-gray-200 h-8 w-40 rounded"></div>
          ) : (
